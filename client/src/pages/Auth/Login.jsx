      ...
      <div className="lg:w-[70%] h-3/4 md:h-full flex flex-col justify-center">
        ...
        <form onSubmit={handleLogin}>
          ...
          <p className="text-[13px] text-slate-800 mt-2">
            <span className="font-semibold"></span> You can use{" "}
            <span className="font-semibold">email - utkarsh@ex.com</span> and{" "}
            <span className="font-semibold">password - utkarsh</span> to log in
            and explore. You can also create your own finance entries after logging in with your own account!
          </p>
        </form>
      </div>
    </AuthLayout>
